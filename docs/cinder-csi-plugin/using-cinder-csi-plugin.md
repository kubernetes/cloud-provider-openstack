...
Stable released version images of the plugin can be found at [Github](https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/images/k8s-staging-provider-os/images.yaml)
