...
func (cs *controllerServer) CreateVolume(ctx context.Context, req *csi.CreateVolumeRequest) (*csi.CreateVolumeResponse, error) {
	...
	klog.V(4).InfoS("CreateVolume(): successfully created", "volumeID", vol.ID, "size", vol.Size, "zone", vol.AvailabilityZone)
...
func (cs *controllerServer) DeleteVolume(ctx context.Context, req *csi.DeleteVolumeRequest) (*csi.DeleteVolumeResponse, error) {
	...
	if err != nil {
		if cpoerrors.IsNotFound(err) {
			klog.V(3).InfoS("Volume already deleted", "volumeID", volID)
	...
	klog.V(4).InfoS("DeleteVolume(): successfully deleted volume", "volumeID", volID)
...
func (cs *controllerServer) ControllerPublishVolume(ctx context.Context, req *csi.ControllerPublishVolumeRequest) (*csi.ControllerPublishVolumeResponse, error) {
	...
	klog.V(4).InfoS("ControllerPublishVolume() successfully attached volume", "volumeID", volumeID, "instanceID", instanceID)
...
func (cs *controllerServer) ControllerUnpublishVolume(ctx context.Context, req *csi.ControllerUnpublishVolumeRequest) (*csi.ControllerUnpublishVolumeResponse, error) {
	...
	if err != nil {
		if cpoerrors.IsNotFound(err) {
			klog.V(3).InfoS("ControllerUnpublishVolume() assuming volume is detached, because node does not exist", "volumeID", volumeID, "instanceID", instanceID)
	...
	if err != nil {
		if cpoerrors.IsNotFound(err) {
			klog.V(3).InfoS("ControllerUnpublishVolume assuming volume is detached, because it was deleted in the meanwhile", "volumeID", volumeID)
			return &csi.ControllerUnpublishVolumeResponse{}, nil
		}
...
func (cs *controllerServer) CreateSnapshot(ctx context.Context, req *csi.CreateSnapshotRequest) (*csi.CreateSnapshotResponse, error) {
	...
	if !backupAlreadyExists {
		...
		if err != nil {
			klog.ErrorS(err, "Failed to WaitSnapshotReady")
			return nil, status.Errorf(codes.Internal, "WaitSnapshotReady failed with error: %v. Current snapshot status: %v", err, snap.Status)
		}
	...
	if snapshotType == "backup" {
		...
		if err != nil {
			...
			return nil, status.Error(codes.Internal, fmt.Sprintf("WaitBackupReady failed with error %v. Current backups status: %s", err, backup.Status))
		}
...
func (cs *controllerServer) DeleteSnapshot(ctx context.Context, req *csi.DeleteSnapshotRequest) (*csi.DeleteSnapshotResponse, error) {
	...
	if err == nil && back != nil {
		...
		if err != nil {
			klog.ErrorS(err, "Failed to Delete backup")
	...
	if err != nil {
		if cpoerrors.IsNotFound(err) {
			klog.V(3).InfoS("DeleteSnapshot() snapshot already deleted", "snapshotID", id)
			return &csi.DeleteSnapshotResponse{}, nil
		}
		klog.ErrorS(err, "Failed to Delete snapshot")
...
func (cs *controllerServer) ListSnapshots(ctx context.Context, req *csi.ListSnapshotsRequest) (*csi.ListSnapshotsResponse, error) {
	...
	if len(snapshotID) != 0 {
		...
		if err != nil {
			if cpoerrors.IsNotFound(err) {
				klog.V(3).InfoS("ListSnapshots(): snapshot not found", "snapshotID", snapshotID)
	...
	if err != nil {
		klog.ErrorS(err, "Failed to ListSnapshots")
...
func (cs *controllerServer) ControllerExpandVolume(ctx context.Context, req *csi.ControllerExpandVolumeRequest) (*csi.ControllerExpandVolumeResponse, error) {
	...
	if volume.Size >= volSizeGB {
		...
		klog.V(2).InfoS("ControllerExpandVolume(): Volume has been already expanded", "volumeID", volumeID, "size", volume.Size)
	...
	klog.V(4).InfoS("ControllerExpandVolume(): resized volume", "volumeID", volumeID, "size", volSizeGB)
