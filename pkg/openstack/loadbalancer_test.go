...
func Test_getStringArrayFromServiceAnnotationSeparateByComma(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "ensure string is well split (if no comma)",
			args: struct {
				service        *corev1.Service
				annotationKey  string
				defaultSetting []string
				...
				service: &corev1.Service{
					ObjectMeta: v1.ObjectMeta{
						Annotations: map[string]string{"my-csv-annotation": "192.168.0.0/24"},
					},
				},
				annotationKey:  "my-csv-annotation",
				defaultSetting: []string{"10.0.0.0/8"}},
		...
		{
			name: "ensure array has no empty string due to several commas",
			args: struct {
				service        *corev1.Service
				annotationKey  string
				defaultSetting []string
				...
				service: &corev1.Service{
					ObjectMeta: v1.ObjectMeta{
						Annotations: map[string]string{"my-csv-annotation": "10.0.0.0/8, 192.168.0.0/24,,"},
					},
				},
				annotationKey:  "my-csv-annotation",
				defaultSetting: []string{"10.0.0.0/8"}},
