...
// IsAllowAll checks whether the net.IPNetSet allows traffic from 0.0.0.0/0
func IsAllowAll(ipnets net.IPNetSet) bool {
...
func GetLoadBalancerSourceRanges(service *v1.Service) (net.IPNetSet, error) {
	var ipnets net.IPNetSet
	var err error
