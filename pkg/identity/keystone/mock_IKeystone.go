...
func (_m *MockIKeystone) GetGroups(_ context.Context, _a0 string, _a1 string) ([]string, error) {
...
func (_m *MockIKeystone) GetTokenInfo(_ context.Context, _a0 string) (*tokenInfo, error) {
	ret := _m.Called(_a0)
